...
export default function Footer() {
  ...
  const email = data?.email || "Info@zarvilalifestyle.com";
  const address =
    data?.address ||
  ...
  return (
    <footer className="bg-[#070707] text-gray-300 py-12 font-manrope mt-6">
  ...
  {description}
          ...
          <p className="mt-6 text-sm text-gray-500">
            © 2025 Zarvilla. All Rights Reserved.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            <a
              href="https://www.facebook.com/zarvilalifestyle"
            ...
            <a
              href="https://www.instagram.com/zarvilalifestyle"
              className="w-10 h-10 flex items-center justify-center border border-gray-600 hover:bg-white hover:text-black transition rounded"
            >
              <FaInstagram />
            </a>
            ...
            <a
              href="https://youtube.com/@zarvilalifestyle"
              className="w-10 h-10 flex items-center justify-center border border-gray-600 hover:bg-white hover:text-black transition rounded"
            >
              <FaYoutube />
            </a>
