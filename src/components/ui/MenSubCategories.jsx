...
//   <div className="max-w-full xl:px-10 mx-auto flex flex-col md:flex-row items-start md:items-center justify-center gap-4">
//     {/* Left Title */}
...
//       {/* LEFT ARROW – শুধু ২য়/৩য় পেজে গেলে আসবে */}
//     {hasPrev && !subsLoading && (
//   <button
//     type="button"
//     onClick={handlePrev}
...
//       {/* RIGHT ARROW – যখন আরও subcategory বাকি থাকে */}
// {hasNext && !subsLoading && (
//   <button
//     type="button"
//     onClick={handleNext}
...
const withBase = (path) => {
  ...
  // ImgBB/full URL হলে base add করবে না
  ...
  useEffect(() => {
    const fetchMenSubs = async () => {
      try {
        ...
        const menSubs = (Array.isArray(data) ? data : []).filter(
          (sub) => sub.parentCategory?.name?.trim().toLowerCase() === "men"
        );
