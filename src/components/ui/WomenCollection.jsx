    ...
    const fetchData = async () => {
      try {
        const [settingsRes, productsRes] = await Promise.all([
          fetch(`${baseURL}/api/home-section-settings/women`),
          fetch(`${baseURL}/api/products/public/home/women?limit=12`),
        ]);
    ...
    return (
      <section className="bg-gradient-to-br from-gray-100 via-gray-200 to-blue-100 py-7 px-5">
        <div className="max-w-full mx-auto text-center px-0 xl:px-3">
          <div className="h-7 w-56 mx-auto bg-gray-300 rounded animate-pulse mb-3" />
