...
const AdminSubCategory = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="mx-auto max-w-full px-0 py-6 md:px-2">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-3xl font-semibold tracking-tight text-gray-800">
              Subcategories
          ...
          <span className="inline-flex h-8 items-center rounded-full border border-gray-200 bg-white px-3 text-sm text-gray-700 shadow-sm">
            Total: <span className="ml-1 font-medium">{subCategories.length}</span>
          </span>
        </div>
            ...
            <div className="sticky top-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <label className="group flex cursor-pointer items-center justify-between gap-3 rounded-lg border border-dashed border-gray-300 bg-gray-50 px-4 py-3 text-sm text-gray-600 transition hover:border-indigo-300 hover:bg-indigo-50">
                    <span className="truncate">
                      {form.image ? form.image.name : "Choose an image"}
                    </span>
                    <span className="rounded-lg bg-white px-3 py-1 text-xs font-medium text-gray-700 shadow-sm">
                ...
                <div className="flex justify-end gap-2">
                  {editingId && (
                    <button
                      type="button"
                      onClick={handleCancelEdit}
                      className="w-1/2 rounded-lg border border-gray-300 py-2 text-sm text-gray-700 hover:bg-gray-50"
                    >
                      Cancel
                    </button>
                  )}
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full rounded-lg bg-indigo-600 py-2 text-sm font-medium text-white shadow transition hover:bg-indigo-700 disabled:opacity-60"
                  >
                    {loading
                      ? "Saving..."
                      : editingId
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
                {subCategories.map((sub) => (
                  ...
                  >
                    ...
                    <div className="border-t border-gray-100 p-3 text-center">
                      <h4 className="line-clamp-1 font-medium text-gray-800">
                        {sub.name}
                      </h4>
                      <p className="text-xs text-gray-500">
                        Parent: {sub.parentCategory?.name || "—"}
